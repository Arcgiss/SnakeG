...
public class MenuScene extends Scene {
    ...
    public MenuScene(KL keyListener, ML mouseListener) {
        ...
        try {
            AtomicReference<BufferedImage> spritesheet = new AtomicReference<>(ImageIO.read(new File("menuSprite.png")));
            title = spritesheet.get( ).getSubimage(0, 242, 960, 240);
            play = spritesheet.get( ).getSubimage(0, 121, 261, 121);
            playPressed = spritesheet.get( ).getSubimage(264, 121, 261, 121);
            exit = spritesheet.get( ).getSubimage(0, 0, 233, 93);
            exitPressed = spritesheet.get( ).getSubimage(264, 0, 233, 93);
